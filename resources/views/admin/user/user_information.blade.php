		...
		<div class="card-body">
			<div class=" align-items-center">
				<div class="row">
					...
					<div style="width: 50%;padding-top:2rem;padding-left:22rem;" class="column"><a href='{{ route ('add.new.user')}}' style="font-family: 'Times New Roman', Times, serif;font-style:bold;color:white;font-size:20px;cursor:pointer;" class="btn btn-success" >ADD NEW USER</a></div>
				</div>
			</div>
		</div>
		<hr>
